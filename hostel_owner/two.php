...
$sql = "INSERT INTO room(room_type,number_of_person,room_size,hostel_id,bathroom,username,room_number) VALUES ('$bedroom','$bathroom','$balconies','$idselection','$garages','$username','$room_number')";
...
<body>
    ...
    <section class="home" style="height: 100%;">
        <div class="text">Add More Details about your hostel</div>
        <div class="container">
            <div class="details">
                ...
                <div class="form-outer">
                    ...
                    echo '
                    <form action="hostel_additional.php?username='.$username.'&id='.$idselection.'"method="POST">'?>
                    ...
                    <div class="page" style="width: 25%;">
                        <div class="title">
                            ...
                            <div class="field">
                               ...
                               <input type="text" name="room_member_name1" id="" placeholder="room_member_name1">
                               <input type="text" name="room_member_name2" id="" placeholder="room_member_name2">
                               <input type="text" name="room_member_name3" id="" placeholder="room_member_name3">
                            </div>
                            ...
                            <div class="field">
                               ...
                               <input type="text" name="room_member_profession1" id="" placeholder="room_member_profession1">
                               <input type="text" name="room_member_profession2" id="" placeholder="room_member_profession2">
                               <input type="text" name="room_member_profession3" id="" placeholder="room_member_profession3">
                            </div>
