...
<div class="banner container">
    ...
    <img class="hostel__card__img" src="../hostel_owner/gallary_images/<?php $im=$q['image']; echo $im;?>" />
        ...
        <div class="hostel__card__room">
          ...
          <a href="view.php?id=<?php echo $q['hostel_id'] ?>&username=<?php echo $_GET['username'];?>" class="btn btn-light">Read More <span class="text-danger">&rarr;</span></a>
      ...
      <a href="hostel.php?username=<?php echo $_GET['username'];?>" class="btn btn-light" style="margin-left: 40%"> <button class="btn_read" style="margin: 25px; height: 50px; width: 400px; background-color: gray; left: 50%"> Load More <span class="text-danger">&rarr;</span></button></a>
