      ...
      <div class="navigation container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid navigation__logo">
            <a class="navbar-brand" href="index.php">HostelWala</a>
            <button
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent navigation__manu">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navigatoin__manu__ul">
                <li class="nav-item">
                  <a class="nav-link active navigatoin__manu__ul__link" aria-current="page" href="index.php">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link navigatoin__manu__ul__link" aria-current="page" href="about.php">About Us</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link navigatoin__manu__ul__link" aria-current="page" href="hostel.php">Hostel</a>
                </li>
               
                <li class="nav-item">
                  <a class="nav-link navigatoin__manu__ul__link" aria-current="page" href="blog.php">Blog</a>
                </li>

                <li class="nav-item">
                  <a class="nav-link navigatoin__manu__ul__link" aria-current="page" href="signup.php">Accounts</a>
                </li>
