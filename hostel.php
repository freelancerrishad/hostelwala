...
<div class="cl" style="display: flex; margin: 10px;">
        ...
        <a href="view.php?id=<?php echo $q['hostel_id'] ?>" class="btn btn-light"> <button class="btn_read" style="margin: 25px; height: 50px; width: 150px;"> Read More <span class="text-danger">&rarr;</span></button></a>
