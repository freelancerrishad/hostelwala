...
<br>
        ...
        <a href="viewblog.php?id=<?php echo $q['blog_id'] ?>" class="btn btn-light"> <button class="btn_read" style="margin: 25px; height: 50px; width: 150px;"> Read More <span class="text-danger">&rarr;</span></button></a>
